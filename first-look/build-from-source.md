...
`### build log/output is published as a sperate file on this github location ###` https://github.com/sarma1807/ApacheSpark2.x/blob/master/first-look/build-from-source-BuildOutput.md
